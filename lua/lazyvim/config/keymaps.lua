...
-- lazygit
map("n", "<leader>gg", function() LazyVim.lazygit( { cwd = LazyVim.root.git() }) vim.opt_local.spell = true end, { desc = "Lazygit (Root Dir)" })
map("n", "<leader>gG", function() LazyVim.lazygit() vim.opt_local.spell = true end, { desc = "Lazygit (cwd)" })
